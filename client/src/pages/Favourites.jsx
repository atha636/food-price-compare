...
/* ── Favourite Card ── */
const FavCard = ({ fav, index, onRemove }) => {
  ...
  return (
    ...
    >
      ...
      {/* Image hero */}
      <div style={{
        height: "170px", position: "relative", overflow: "hidden", flexShrink: 0,
      ...
      <div style={{
        ...
        <aside style={{
          ...
          <div
            style={{
              ...
              marginBottom: "32px", cursor: "pointer", overflow: "hidden",
            }}
        ...
        <main style={{
          ...
          {darkMode && <>
            ...
            <div style={{
              position: "fixed", bottom: "-160px", left: "-80px",
          ...
          <div style={{ position: "relative", zIndex: 1, maxWidth: "1200px" }}>
            ...
            <div style={{
              ...
              <div>
                <p style={{
                  ...
                  color: "#f472b6", marginBottom: "8px", fontWeight: 500,
                }}>
                  ● Saved Spots
                </p>
                <h1 style={{
              ...
              <div style={{ display: "flex", gap: "14px", flexWrap: "wrap" }}>
                {[
                  { label: "Saved",       value: favourites.length, accent: "#f472b6" },
                  ...
                  <div key={s.label} style={{
                    ...
                    <p style={{ fontSize: "10px", color: textMuted, letterSpacing: "0.06em", marginTop: "2px" }}>
                      {s.label}
                    </p>
                  </div>
                ))}
            ...
            {loading ? (
              <div style={{ textAlign: "center", padding: "80px 0" }}>
                ...
                <p style={{ color: textMuted, fontSize: "14px" }}>Loading favourites…</p>
              </div>
              ...
              <div style={{
                ...
                {favourites.map((fav, i) => (
                  <FavCard key={i} fav={fav} index={i} onRemove={removeFavourite} />
                ))}
              </div>
            )}
            ...
            <p style={{
              ...
              fontSize: "11px", color: darkMode ? "#1e293b" : "#cbd5e1",
